...
class SoundManager {
    ...
    manifest = {
        ...
        'chicken.step': { src: 'audio/chicken/step.mp3', bus: 'characters', loop: false, gain: 0, pool: 3 },
        'chicken.dead': { src: 'audio/chicken/dead.mp3', bus: 'characters', loop: false, gain: 0.4, pool: 2 },
        'chicken-small.step': { src: 'audio/chicken-small/step.mp3', bus: 'characters', loop: false, gain: 0, pool: 3 },
